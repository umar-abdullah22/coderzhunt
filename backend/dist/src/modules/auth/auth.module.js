    ...
    (0, common_1.Module)({
        imports: [
            ...
            jwt_1.JwtModule.registerAsync({
                ...
                useFactory: (config) => ({
                    secret: process.env.JWT_SECRET || config.get(src_1.ConfigEnum.JWT_TOKEN).secret,
                    signOptions: {
                        expiresIn: process.env.JWT_EXPIRES || config.get(src_1.ConfigEnum.JWT_TOKEN).expireIn,
                    },
                }),
            }),
