...
const src_1 = require("../../../libs/constants/src");
const auth_service_1 = require("./auth.service");
const user_entity_1 = require("../user/entities/user.entity");
const src_2 = require("../../../libs/dtos/src");
const src_3 = require("../../../libs/types/src");
...
let AuthController = class AuthController {
    constructor(authService, authHelper) {
    ...
    async statsUserReplies(token, params) {
        return await this.authService.getUserReplies(token, params);
    }
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [src_2.UserRegisterRequestDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [src_2.AdminModRegisterRequestDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [src_2.LoginRequestDto]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "login", null);
__decorate([
    (0, common_1.UseGuards)(guards_1.JwtAuthGuard, guards_1.RolesGuard),
    (0, src_3.UserRole)(src_3.UserRoleEnum.ADMIN),
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [src_2.ForgetRequestDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, src_2.ResetPasswordRequestDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, common_1.UseGuards)(guards_1.JwtAuthGuard, guards_1.RolesGuard),
    (0, src_3.UserRole)(src_3.UserRoleEnum.CUSTOMER, src_3.UserRoleEnum.MODERATOR),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Forbidden.' }),
...
__decorate([
    (0, common_1.UseGuards)(guards_1.JwtAuthGuard, guards_1.RolesGuard),
    (0, src_3.UserRole)(src_3.UserRoleEnum.ADMIN, src_3.UserRoleEnum.MODERATOR),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Forbidden.' }),
...
__decorate([
    ...
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, src_2.ScheduleMessageDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(2, (0, common_1.UploadedFile)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, src_2.SpamMessagesDto, Object]),
    __metadata("design:returntype", Promise)
...
AuthController = __decorate([
    ...
    (0, swagger_1.ApiTags)(src_1.SWAGGER_API_TAG.AUTH),
    __metadata("design:paramtypes", [auth_service_1.AuthService, auth_helper_1.AuthHelper])
], AuthController);
