...
let ChatsGateway = class ChatsGateway {
    ...
    async handleConnection(socket, _) {
        ...
        try {
            ...
            if ((user === null || user === void 0 ? void 0 : user.role) === src_1.UserRoleEnum.MODERATOR) {
    ...
    async handleDisconnect(socket) {
        ...
        if (((_b = (_a = socket === null || socket === void 0 ? void 0 : socket.data) === null || _a === void 0 ? void 0 : _a.user) === null || _b === void 0 ? void 0 : _b.role) === src_1.UserRoleEnum.MODERATOR) {
    ...
    async onSendMessage(socket, data) {
        ...
        try {
            ...
            if (senderUser && receiverUser) {
                ...
                if (senderSocket || modSocket || (receiverUser === null || receiverUser === void 0 ? void 0 : receiverUser.role) === src_1.UserRoleEnum.FAKE) {
                    ...
                    let moderatorUser = await this.chatService.findUserById(data.moderator);
                    if (moderatorUser.status === src_1.UserStatusEnum.BLOCK || moderatorUser.status === src_1.UserStatusEnum.INACTIVE) {
                    ...
                    if (res) {
                        if (modSocket || (receiverUser === null || receiverUser === void 0 ? void 0 : receiverUser.role) === src_1.UserRoleEnum.FAKE) {
                        ...
                        if ((moderatorIds === null || moderatorIds === void 0 ? void 0 : moderatorIds.length) > 0) {
                            const unseenMessages = await this.chatService.getUnseenMessagesCount(data.receiver);
                            for (const moderatorId of moderatorIds) {
                                const moderatorSocket = this.moderatorSockets.get(moderatorId);
                                if (moderatorSocket) {
                                    moderatorSocket.emit('receiveMessage', data);
                                    moderatorSocket.emit('getUnseenMessageCountNotification', unseenMessages);
                                }
                            }
                        }
                    }
    ...
    notifyModerators() {
        const customerClients = Array.from(this.connectedClients.entries()).filter(([_, socket]) => { var _a, _b; return ((_b = (_a = socket === null || socket === void 0 ? void 0 : socket.data) === null || _a === void 0 ? void 0 : _a.user) === null || _b === void 0 ? void 0 : _b.role) === src_1.UserRoleEnum.CUSTOMER; });
