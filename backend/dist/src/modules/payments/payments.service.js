...
let PaymentsService = class PaymentsService {
    ...
    async grantCoinsForPackage(user, packageId) {
        const currentCoins = await this.userService.getCurrentCoinsFromDB(user);
        const cost = await (0, src_1.getAmountForEachAction)(src_1.TransactionActionTypes.PACKAGE_SUBSCRIPTION, packageId, this.subscriptionService);
