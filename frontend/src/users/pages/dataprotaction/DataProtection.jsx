      ...
      <div className={styled.contentBody}>
        <div className={styled.container}>
          ...
          <div className={styled.bg}>
            <p>
              <b>
                Welcome to the Zizle community! At Zizle , we care about your privacy and
                trust, so this privacy policy (the &quot;Policy&quot;) tells you how we treat your
                ...
                link to this policy, but also our products and applications (including Zizle
                mobile applications, downloadable products and applications, and pages operated by
                Zizle on social networks and other platforms will)
              </b>
            </p>
          </div>
          <p>
          ...
          <ul>
            <li>➢ c) Payment service providers</li>
            <br />
          ...
          <ul>
            ...
            <li>
              <p>➢ c) Proof of Identity</p>If we request proof of identity from you (e.g. a copy of
          ...
          <p>
            Please use your internet browser&apos;s help function to obtain information on changing these
            settings. However, some websites - including ours - cannot be used properly without
            cookies, as these files are required for certain processes, such as the chat function.
            We would therefore like to point out that individual functions of our website cannot
            work if you use the have disabled the use of cookies. Cookies do not allow a server to
            read private data from your computer or data stored by another server. They do not cause
            any damage to your computer and do not contain any viruses.
          </p>
          <p>
          ...
          <p>
            ...
            and that enable an analysis of your use of the website. The information generated by the
            cookie about your use of this website is usually sent to a Google server in transferred
