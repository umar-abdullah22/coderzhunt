...
FakeModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([user_entity_1.User, customer_profiledata_entity_1.CustomerProfileData, fakeUser_entity_1.FakeCreator, email_entity_1.Email]), chat_module_1.ChatModule, auth_module_1.AuthModule],
        controllers: [fake_controller_1.FakeController],
        providers: [fake_service_1.FakeService, user_service_1.UserService, mail_service_1.MailService, cloudinary_config_1.CloudinaryConfigService],
