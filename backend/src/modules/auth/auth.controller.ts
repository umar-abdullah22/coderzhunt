...
export class AuthController {
  constructor(private readonly authService: AuthService, private readonly authHelper: AuthHelper) {}
  ...
  async statsUserReplies(@Headers('authorization') token: string, @Query() params: GetModsStatsQueryParamsDto) {
