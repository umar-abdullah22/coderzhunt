import { CreateActionTypeDto, CreateGiftDto, SetCostDto } from '../../../libs/dtos/src';
...
export declare class CoinsController {
    ...
    createGift(token: string, createGiftDto: CreateGiftDto | any, file: any): Promise<import("../user/entities/user.transaction.actiontypes.entity").UserTransactionActionTypes>;
    ...
    deleteGift(id: string): Promise<import("../../../libs/dtos/src").GlobalResponseDto>;
}
