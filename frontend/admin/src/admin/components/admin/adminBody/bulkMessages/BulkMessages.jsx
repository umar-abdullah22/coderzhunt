...
import { sendSpamMessagesAction } from './../../../../../store/slices/adminAPI/actions';
...
const BulkMessages = () => {
  ...
  const { userList, fakeUserBulkIds, realCustomerBulkIds } = useSelector((state) => state.adminApi)
