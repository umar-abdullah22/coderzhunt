...
AnnouncementsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([user_entity_1.User, announcement_entity_1.Announcement, email_entity_1.Email]), auth_module_1.AuthModule],
        controllers: [announcement_controller_1.AnnouncementController],
        providers: [user_service_1.UserService, announcement_service_1.AnnouncementService, mail_service_1.MailService, cloudinary_config_1.CloudinaryConfigService],
    })
], AnnouncementsModule);
