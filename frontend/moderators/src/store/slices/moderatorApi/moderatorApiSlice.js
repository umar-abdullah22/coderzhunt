...
import {
  modCustomerListAction, emptyStateAction, sendBulkVistsAction, createNotesAction, getCustomerNoteAction, getFakeUserNoteAction, updateNoteAction, getAllNotesAction, deleteNoteAction
} from './actions';
...
export const moderatorApiSlice = createSlice({
  ...
  extraReducers: {
    ...
    // modCustomerListAction list data
