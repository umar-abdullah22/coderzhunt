...
@Module({
  imports: [
    TypeOrmModule.forFeature([User, Payments, Subscription, UserAccountTransaction, UserTransactionActionTypes, Email]),
    AuthModule,
  ],
  controllers: [PaymentsController],
  providers: [PaymentsService, UserService, MailService, SubscriptionsService, CloudinaryConfigService],
})
